...
$resourceGroup = "000PluralsightAcr"
az group create -n $resourceGroup -l westeurope

# create a new Azure container registry
$registryName = "000pluralsightacr"
az acr create -g $resourceGroup -n $registryName --sku Basic --admin-enable true
# password  3Snsyt3EHugnU=eOWKzsN37au3jYiqR4
# password2 uf6PmU35uHSePC2CAN8fEI/s5EH/NyD3
